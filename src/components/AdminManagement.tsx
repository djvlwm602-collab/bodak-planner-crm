...
import { Search, RotateCw, ChevronDown, ChevronRight, ChevronLeft, ChevronsLeft, ChevronsRight, Users, UserPlus, UserCheck, UserX } from 'lucide-react';
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-white overflow-hidden">
      ...
      <div className="px-6 py-5 border-b border-gray-200 flex items-center shrink-0">
        <h1 className="text-[19px] font-bold text-gray-900 tracking-tight mr-4">운영/관리자</h1>
        <span className="text-sm text-gray-500">서비스를 이용하는 직원을 관리할 수 있습니다.</span>
      </div>
