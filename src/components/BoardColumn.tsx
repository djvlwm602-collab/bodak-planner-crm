...
export function BoardColumn({ column, tasks, onDragStart, onDrop, onCreateTask }: BoardColumnProps) {
  ...
  return (
    <div className="flex flex-col w-full min-w-[200px] bg-bg-kanban-column rounded-md h-full">
      <div className="flex items-center gap-2 p-3 pb-2 shrink-0">
        <h3 className="text-xs font-medium text-text-quaternary uppercase tracking-wide truncate">
          {column.title}
        </h3>
