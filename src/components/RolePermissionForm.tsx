    ...
    <div className="flex-1 flex flex-col h-full bg-white overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto px-[30px] py-8">
        <div className="w-full flex flex-col gap-10">
          ...
          <div>
            ...
            <div className="border border-gray-300 p-6 bg-gray-50/30">
              <div className="flex items-center gap-2">
                ...
                />
                <button className="bg-black text-white px-4 py-1.5 rounded-sm text-sm font-medium hover:bg-gray-800 transition-colors">
                  중복체크
                </button>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="border border-gray-300">
              ...
              <div className="flex border-b border-gray-200">
                <div className="w-[200px] bg-gray-50 px-6 py-4 text-sm font-bold text-gray-900 border-r border-gray-200 flex items-center">
                  홈 대시보드
                </div>
          ...
          {/* Footer Actions */}
          <div className="flex justify-between pt-6 border-t border-gray-900 mt-4 mb-8">
            <button className="bg-red-500 text-white px-10 py-2 rounded-sm text-sm font-medium hover:bg-red-600 transition-colors">
              삭제
            </button>
            <div className="flex gap-2">
              ...
              <button className="bg-black text-white px-10 py-2 rounded-sm text-sm font-medium hover:bg-gray-800 transition-colors">
                확인
              </button>
            </div>
          </div>
