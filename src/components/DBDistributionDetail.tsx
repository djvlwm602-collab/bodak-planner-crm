    ...
    return nodes.map((node, index) => {
      ...
      <div key={index} className="w-full min-w-max">
        ...
        >
          ...
          >
            <span className={cn("text-sm font-medium", level === 0 && "font-bold")}>
              {node.name}
            </span>
          </div>
      ...
      <div className="flex-1 overflow-y-auto p-8">
        <div className="max-w-7xl mx-auto flex flex-col">
          ...
          <div className="flex border-b border-gray-300 mb-6">
            <button 
              className={cn(
                "px-12 py-3 text-sm font-bold border-b-2 transition-colors",
            ...
            <div className="flex-1 flex flex-col min-w-0">
              ...
              <div className="bg-gray-50 border border-gray-200 py-6 px-8 flex justify-center gap-16 mb-6 shrink-0">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-base font-bold text-gray-900">총 공급 수량 : 1,100건</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-1 h-1 bg-black rounded-full"></div>
                  <span className="text-base font-bold text-gray-900">총 배정 수량 : 1,100건</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-1 h-1 bg-black rounded-full"></div>
                  <span className="text-base font-bold text-gray-900">미배정 수량 : 20건</span>
                </div>
              </div>
                ...
                {activeTab === '설계사 별 수량' ? (
                  <table className="w-full text-sm text-center">
                    <thead className="bg-gray-50 border-b border-gray-300 sticky top-0">
                      <tr>
                        <th className="py-3 font-bold text-gray-900 w-16">No.</th>
                        <th className="py-3 font-bold text-gray-900 w-24">이름</th>
                        <th className="py-3 font-bold text-gray-900 w-24">아이디</th>
                        <th className="py-3 font-bold text-gray-900 w-36">휴대폰번호</th>
                        <th className="py-3 font-bold text-gray-900">소속</th>
                        <th className="py-3 font-bold text-gray-900 w-32">실 배정 수량</th>
                      </tr>
                    </thead>
                    <tbody>
                  ...
                  <table className="w-full text-sm text-center">
                    <thead className="bg-gray-50 border-b border-gray-300 sticky top-0">
                      <tr>
                        <th className="py-3 font-bold text-gray-900 w-32">권역</th>
                        <th className="py-3 font-bold text-gray-900">총 공급 수량</th>
                        <th className="py-3 font-bold text-gray-900">실 배정 수량</th>
                        <th className="py-3 font-bold text-gray-900">미배정 수량</th>
                      </tr>
                    </thead>
                    <tbody>
